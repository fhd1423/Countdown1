...
const addToList = (bookObject) => {
  bookList.push(bookObject)
}

const removeFromlist = (bookObject) => {
...
const listOut = () => {
  console.log('titles', bookList.keys)
  console.log('authors', bookList.values)
}
...
const check = (number) => number > 0 ? console.log('positive') : console.log('negative')
